...
export const CardTool: React.FC<CardProps> = ({imagem, title, status}) => {
    return(
        <div className="flex flex-col relative w-64 h-[250px] m-4 bg-white rounded-3xl align-center shadow-md shadow-slate-100 hover:scale-110 transition easy-in-out text-black shadow-lg shadow-indigo-500/40">
            <Image src={imagem === 1 ? img1 : imagem === 2 ? img2 : imagem === 3 ? img3 : img4} alt="imagem" className="h-40 object-fit rounded-t-3xl"/>
